...
export default function Page({ params }: { params: { date: string } }) {
  ...
  return (
    <main className="flex flex-col h-screen">
      ...
      >
        <div
          className="w-14 flex items-center justify-center cursor-pointer
      ...
      >
        <div
          className="mt-8 sm:flex sm:flex-col sm:items-center
                lg:w-1/2"
        >
          {/*SUMMARY*/}
          <div className="px-2 mb-6">
            ...
            <div
              className="flex justify-between mt-5 border border-gray-100 rounded-lg p-3 shadow-custom-heavy
                        sm:gap-14"
            >
          ...
          <div
            className="hidden
                            ...
                            3xl:w-3/5"
          >
            <form onSubmit={handleSubmit(createTransaction)} className="py-8">
              <div className="flex items-center w-full gap-3 flex-wrap justify-center">
                ...
                {createTransactionIsLoading ? (
                  ...
                  <button
                    className="flex items-center justify-center mt-5 h-10 cursor-pointer px-5 rounded-md
